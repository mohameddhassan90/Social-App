        ...
        {imgPrevew && (
          <div className="relative">
            ...
            <button
              ...
              className="cursor-pointer abqsolute right-2 top-2 rounded-full bg-black/60 p-1 text-white backdrop-blur-sm"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width={16}
        ...
        <div className="mt-3 flex flex-wrap items-center justify-between gap-2 border-t border-border pt-3">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {isPending ? `` : <i className="fa-regular fa-paper-plane "></i>}
            </button>
          </div>
        </div>
      </div>
